...
// Logotip Plaat en blanc (fons transparent) — mateix wordmark que a l'Acta VO, per a fons foscos de la UI
const LOGO_PLAAT_BLANC_B64 = '';
...
// Normalitza text per a cerca: minúscules i sense accents, perquè "instal·lació" trobi "instalacio"
    ...
    <div style={{ width: 210, background: '#1C1C1A', display: 'flex', flexDirection: 'column', flexShrink: 0, height: '100%' }}>
      ...
      <div style={{ padding: '24px 20px 20px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 7 }}>
          <img src={`data:image/png;base64,${LOGO_PLAAT_BLANC_B64}`} alt="Plaat" style={{ height: 19, width: 'auto' }} />
...
function ModuloActaVO({ obra, onSave }) {
  ...
  // Carrega automàtica de 7 dies de clima real (Open-Meteo) — a partir de la ubicació marcada al mapa
  ...
  return (
    <div>
      ...
      <div style={{ position: 'relative', marginBottom: 14 }}>
        ...
        {buscarTema && (
          <button onClick={() => setBuscarTema('')} title="Netejar"
            style={{ position: 'absolute', right: 8, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: '#BFBEB9', fontSize: 15, lineHeight: 1, padding: 4 }}>×</button>
        )}
      </div>

      {/* Secciones editables — cada una plegable; temes en ordre d'inserció (els nous sempre al final real) */}
      {(() => {
        const busq = buscarTema.trim();
        const busqN = normTxt(busq);
        const seccionsFiltrades = (vo.secciones||[]).map(sec => {
          const activos = activosPorSec(sec.id);
          const visibles = busq ? activos.filter(t => normTxt(t.titulo).includes(busqN) || normTxt(t.num).includes(busqN)) : activos;
          return { sec, activos, visibles };
        });
        const capCoincidencia = busq && seccionsFiltrades.every(({ visibles }) => visibles.length === 0);
        return (
          <>
            {capCoincidencia && (
              <div style={{ textAlign: 'center', padding: '22px 10px', color: '#A5A5A0', fontSize: 12.5 }}>
                Cap tema coincideix amb "{busq}".
              </div>
            )}
            {seccionsFiltrades.map(({ sec, activos, visibles }) => {
              if (busq && visibles.length === 0) return null;
              const pendents = activos.filter(t => estatAgregatTema(t) === 'P').length;
              const colapsada = busq ? false : !!seccColapsades[sec.id];
              return (
...
function TemaVO({ t, est, secId, voNum, secciones, resaltar, onUpdEntrada, onUpdTema, onAddEntrada, onAddFoto, onDelFoto, onEditFoto, onDelEntrada, onMover, onReordenar, onDel }) {
  ...
  // Marca en groc el fragment del títol que coincideix amb la cerca activa
  function resaltarCoincidencia(text, query) {
    if (!query) return text;
    const norm = normTxt(text);
    ...
    return (
      <>
        {text.slice(0, idx)}
        <mark style={{ background: '#FEF3DB', color: 'inherit', borderRadius: 2, padding: '0 1px' }}>{text.slice(idx, idx + q.length)}</mark>
    ...
    <div style={{ background: '#fff', border: `1px solid ${abierto ? '#D8D7D1' : '#EDECE7'}`, borderRadius: 10, marginBottom: 5, overflow: 'hidden', transition: 'border-color .15s' }}>
      ...
      <div onClick={() => setAbierto(v => !v)}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          ...
          <span style={{ flex: 1, fontSize: 13.5, fontWeight: 600, color: '#141412', lineHeight: 1.35, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{resaltarCoincidencia(tituloDisplay, resaltar)}</span>
...
function QuickAddTema({ secciones, obraId, onAdd, onCancel }) {
  ...
  function afegirFotos() {
    setPujantFoto(true);
    pickFiles('image/*', f => { setFotos(prev => [...prev, f]); setPujantFoto(false); }, obraId);
  }
  function treureFoto(id) { setFotos(prev => prev.filter(f => f.id !== id)); }
  ...
  return (
    <Modal title="Nou tema" onClose={onCancel} footer={
      ...
      <Field label="Descripció / primer seguiment">
      ...
      <div>
        <label style={{ display: 'block', fontSize: 12, fontWeight: 500, color: '#52524E', marginBottom: 5 }}>Fotos</label>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
          {fotos.map(f => (
          ...
          <button onClick={afegirFotos} disabled={pujantFoto}
            style={{ width: 68, height: 51, borderRadius: 6, border: '1.5px dashed #E5E4DF', background: '#FAFAF8', cursor: 'pointer', fontSize: 11, color: '#9B9B97', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {pujantFoto ? '…' : '+ foto'}
          </button>
        </div>
        {editandoFoto && (
...
async function generarActaVO_v2(obra, vo, idioma = 'ca') {
  ...
  if ((hitos.esenciales||[]).length > 0 || (hitos.intermedios||[]).length > 0) {
    const c6H = 5.5;
    const c6Cod=14, c6Desc=64, cPlan=26, cFP=25, cFR=25, cRD=CW-c6Cod-c6Desc-cPlan-cFP-cFR;
    ...
    // 4 columnes de capçalera (Planning contractual / Fecha prevista / Fecha real / Retraso), cap
    // d'elles encaixada al final de la columna de títol (hi xocava quan el títol era llarg).
    doc.setFillColor(...GRIS15);
    ...
    // "Planning contractual" és el text més llarg de les 4 capçaleres — si no hi cap a la seva
    // columna a 6.5pt es redueix, i s'aplica la MATEIXA mida a les altres 3 perquè totes quatre
    // quedin visualment iguals (abans només "planning" sortia més petita que la resta).
    doc.setFontSize(6.5);
    const midaCapc = doc.getTextWidth(T.planning) > cPlan - 4 ? 5.3 : 6.5;
    doc.setFontSize(midaCapc);
    [[ML+c6Cod+c6Desc, cPlan, T.planning],
     [ML+c6Cod+c6Desc+cPlan, cFP, T.fechaPrevista],
     [ML+c6Cod+c6Desc+cPlan+cFP, cFR, T.fechaReal],
     [ML+c6Cod+c6Desc+cPlan+cFP+cFR, cRD, T.retrasoDias]]
    ...
    function dibuixaGrupHitos(nomGrup, items) {
      ...
      items.forEach((it) => {
        ...
        doc.text(retard, ML+c6Cod+c6Desc+cPlan+cFP+cFR+cRD/2, y+rh/2, { align:'center', baseline:'middle' });
        doc.setTextColor(0,0,0);
